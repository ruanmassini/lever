        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-10 d-flex flex-row">
                    <h1 class="m-0 align-self-center">Usuários</h1>
                </div>
                <div class="col-md-2 d-flex justify-content-end">
                    <a href="{{ route('user.create') }}" data-toggle="tooltip" title="" class="btn btn-lg btn-primary"
            ...
            <div class='table-responsive'>
                <table class='table table-bordered table-hover'>
                    <tr>
                        ...
                        <th class='text-center align-middle col-4'>Nome</th>
                        <th class='text-center align-middle col-3'>Email</th>
                        <th class='text-center align-middle col-3'>Data de criação</th>
                    ...
                    @foreach ($findUser as $User)
                        <tr>
                            ...
                            <th class='text-center align-middle'>{{ $User->created_at }}</th>
                            <th class='text-center align-middle'>
                                <div class="row justify-content-center">
                                    <div class="col-sm">
                                        <a href="{{ route('user.update', $User->id) }}" data-toggle="tooltip" title=""
